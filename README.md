Multi-modal Learning Project with Vison Based Models  
Using CLIP for Connecting Text and Images  
Matthew Harper 
...
exercise.  
Introduction 
Figure 1 – Simplistic multi-modal model representation illustrating the multiple 
sourced sensory input into model processing for predicted outcome [2]. 
...
f
ields, including image captioning, visual question answering, and cross-modal retrieval. VLMs achieve this 
